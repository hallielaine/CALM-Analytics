...
/* package */final class JsonObjects
{
    ...
    public static final class BlobHeader
    {
        ...
        public static final class Attributes
        {
             ...
             */
            public static final String KEY_CLIENT_APP_VERSION = "av__c"; //$NON-NLS-1$

            /**
             * Key which maps to the SHA-256 of the device's {@link android.provider.Settings.Secure#ANDROID_ID}.
             */
            public static final String KEY_DEVICE_ANDROID_ID_HASH = "du__c"; //$NON-NLS-1$
             ...
             */
            public static final String KEY_DEVICE_MANUFACTURER = "dma__c"; //$NON-NLS-1$
             ...
             */
            public static final String KEY_DEVICE_MODEL = "dmo__c"; //$NON-NLS-1$
             ...
             */
            public static final String KEY_DEVICE_OS_VERSION = "dov__c"; //$NON-NLS-1$
             ...
             */
            public static final String KEY_LOCALE_COUNTRY = "dlc__c"; //$NON-NLS-1$
             ...
             */
            public static final String KEY_LOCALE_LANGUAGE = "dll__c"; //$NON-NLS-1$
             ...
             * Api key
             */
            public static final String KEY_LOCALYTICS_API_KEY = "au__c"; //$NON-NLS-1$
             ...
             */
            public static final String KEY_LOCALYTICS_CLIENT_LIBRARY_VERSION = "lv__c"; //$NON-NLS-1$
             ...
             */
            public static final String KEY_NETWORK_CARRIER = "nca__c"; //$NON-NLS-1$
    ...
    /* package */static final class SessionOpen
    {
         ...
         */
        public static final String KEY_WALL_TIME_SECONDS = "st__c"; //$NON-NLS-1$
         ...
         */
        public static final String KEY_EVENT_UUID = "u__c"; //$NON-NLS-1$
    ...
    /* package */static final class SessionClose
    {
         ...
         */
        public static final String KEY_SESSION_END_TIME = "et__c"; //$NON-NLS-1$
         ...
         * UUID of the session.
         */
        public static final String KEY_SESSION_UUID = "u__c"; //$NON-NLS-1$
    ...
    /* package */static final class SessionEvent
    {
         ...
         * @see #VALUE_DATA_TYPE
         */
        public static final String KEY_DATA_TYPE = "dt__c"; //$NON-NLS-1$
         ...
         * Epoch timestamp when the session was started in seconds.
         */
        public static final String KEY_WALL_TIME_SECONDS = "ct__c"; //$NON-NLS-1$
         ...
         * UUID of the session.
         */
        public static final String KEY_SESSION_UUID = "su__c"; //$NON-NLS-1$
         ...
         * Name of the event.
         */
        public static final String KEY_NAME = "n__c"; //$NON-NLS-1$
